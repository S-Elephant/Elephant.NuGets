namespace Elephant.Types.Interfaces.ResponseWrappers
{
		...
		where TData : new()
	{
		...
		/// </summary>
#pragma warning disable CA1716 // CA1716: Identifiers should not match keywords. TODO: rename this method so it no longer conflicts with language keywords.
		IResponseWrapper<TData> Error(int statusCode, string? message = null, TData? data = default);
#pragma warning restore CA1716 // CA1716: Identifiers should not match keywords.
