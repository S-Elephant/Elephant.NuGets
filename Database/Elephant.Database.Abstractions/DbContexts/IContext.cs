...
namespace Elephant.Database.Abstractions.DbContexts
{
	/// <summary>
...
#pragma warning disable CA1716 // Identifiers should not match keywords. Reason: Matching Entity Framework Core's DbContext.Set<TEntity>() method signature for interface compatibility.
...
#pragma warning restore CA1716 // Identifiers should not match keywords.
		...
		///         a transaction, first call <see cref="BeginTransaction" /> or UseTransaction.
		///     </para>
		///     <para>
