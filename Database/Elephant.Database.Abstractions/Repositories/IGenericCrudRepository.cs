...
namespace Elephant.Database.Abstractions.Repositories
{
		...
		where TEntity : class
	{
		...
		/// </summary>
		Task<IResult<int>> DeleteAndSave(object id, CancellationToken cancellationToken);
		...
		/// Insert and save.
		/// </summary>
		Task<IResult<int>> InsertAndSave(TEntity obj, CancellationToken cancellationToken);
		...
		/// </summary>
		Task<IResult<int>> UpdateAndSave(TEntity obj, CancellationToken cancellationToken);
