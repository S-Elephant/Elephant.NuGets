...
namespace Elephant.DataAnnotations.Tests
{
	...
	/// </summary>
	public class EqualsAnotherPropertyStringTests
	{
		/// <summary>
		/// <see cref="EqualsAnotherPropertyStringAttribute"/> case-sensitive tests.
		/// </summary>
		[Theory]
		...
		/// <summary>
		/// <see cref="EqualsAnotherPropertyStringAttribute"/> case-insensitive tests.
		/// </summary>
		[Theory]
		[InlineData(null, null, null, true)]
		[InlineData(null, "", null, false)]
		...
		private class ValidationTargetString
		{
			...
			/// </summary>
			[EqualsAnotherPropertyString("B")]
			[EqualsAnotherPropertyString("C")]
			public string? A { get; set; }

			[EqualsAnotherPropertyString("A")]
		...
		private class ValidationTargetStringCaseInsensitive
		{
			...
			/// Property to validate.
			/// </summary>
			[EqualsAnotherPropertyString("B", false)]
			[EqualsAnotherPropertyString("C", false)]
			public string? A { get; set; }

			[EqualsAnotherPropertyString("A", false)]
			public string? B { get; set; }
