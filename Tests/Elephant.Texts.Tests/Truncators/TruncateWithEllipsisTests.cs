...
namespace Elephant.Texts.Tests.Truncators
{
	...
	public class TruncateWithEllipsisTests
	{
		...
		public void NullValue_ReturnsNull()
		{
			...
			// Act.
			string? result = Truncator.TruncateWithEllipsis(value, maxLength);
		...
		public void DoesNotSplitGraphemeClusters()
		{
			...
			// Act.
			string? result = Truncator.TruncateWithEllipsis(value, maxLength, ellipsis, allowGraphemeOverflow: true);
		...
		public void NullEllipsis_TreatedAsEmpty()
		{
			...
			// Act.
			string? result = Truncator.TruncateWithEllipsis(value, maxLength, ellipsis: null!);
		...
		public void CustomMultiCharEllipsis_Works()
		{
			...
			// Act.
			string? result = Truncator.TruncateWithEllipsis(value, maxLength, ellipsis);
		...
		/// <summary>
		/// <see cref="Truncator.TruncateWithEllipsis"/>
		...
		{
			// Act.
			string? result = Truncator.TruncateWithEllipsis(value, maxLength, ellipsis, allowGraphemeOverflow);
