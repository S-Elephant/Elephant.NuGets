...
{
    /// <summary>
    /// <see cref="PathFolderMaxLengthAttribute"/> tests.
    /// </summary>
    public class PathFolderMaxLengthTests
    {
        /// <summary>
        ...
        /// <summary>
        /// <see cref="PathFolderMaxLengthAttribute"/> test without data.
        /// </summary>
        [Fact]
