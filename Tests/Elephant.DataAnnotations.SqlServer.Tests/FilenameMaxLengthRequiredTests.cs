...
{
    /// <summary>
    /// <see cref="FilenameMaxLengthRequiredAttribute"/> tests.
    /// </summary>
    public class FilenameMaxLengthRequiredTests
    {
        /// <summary>
        ...
        /// <summary>
        /// <see cref="FilenameMaxLengthRequiredAttribute"/> test without data.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// <see cref="FilenameMaxLengthRequiredAttribute"/> test with data.
        /// </summary>
        [Theory]
        [InlineData("")]
        [InlineData("a")]
