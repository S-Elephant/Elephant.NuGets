using Elephant.Common.ResponseWrappers;
using Xunit.Categories;

namespace Elephant.Common.Tests.ResponseWrappers
{
    /// <summary>
    ...
    public class PagedResponseWrapperTests
    {
        ...
        public void TestIfAddingReturnsExpectedValuesUsingConstructorOverload()
        {
            ...
            // Act.
            PagedResponseWrapper<int> sut = new(data, true, 200, null, "Success.", 1, 2, 2, true, false, data.Count, string.Empty, string.Empty);
        ...
        [Fact]
        [SpeedVeryFast]
        public void TestIfBadRequestReturnsNoData()
        {
            // Arrange
            List<int> data = new() { 5, 15, 25 };
            PagedResponseWrapper<int> sut = new(data, true, 200, null, "Success.", 1, 2, 2, true, false, data.Count, string.Empty, string.Empty);
